...
- Audience: Mix of builders and casual followers — more professionals,
...
- First line is EVERYTHING. LinkedIn truncates after ~210 characters
  with a "see more" button. If your hook isn't in that first line,
  nobody clicks.
- Use [Hooks](../engine/hooks.md) — proof hooks and playbook hooks perform best.
- Match [Brand Voice](../voice/brand-voice.md) but more professional. See [Platform Tone](../voice/platform-tone.md).
...
- The hook usually needs a full rewrite — what works on X doesn't
  always translate to LinkedIn.
- Can extract slides from this for [Instagram](instagram.md) carousels.
